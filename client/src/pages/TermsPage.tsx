...
export default function TermsPage() {
  return (
    <>
      <SEOHead
        title="T e r m s â€” Malhotra Classes"
        description="Learn more about T e r m s at Malhotra Classes, Rohtak's premier coaching institute."
      />
        ...
        <Container>
          <div className="rounded-2xl border border-border-default bg-white p-8 lg:p-12 shadow-sm">
            ...
            <div className="prose prose-lg text-text-secondary max-w-none">
              <p>
                We are in the process of adding detailed content for <strong>T e r m s</strong>. 
