...
export default function CareerGuidancePage() {
  return (
    <>
      <SEOHead
        title="C a r e e r G u i d a n c e â€” Malhotra Classes"
        description="Learn more about C a r e e r G u i d a n c e at Malhotra Classes, Rohtak's premier coaching institute."
      />
      ...
      <div className="bg-brand-navy pt-8 pb-16 lg:pt-12 lg:pb-24">
        <Container>
          <Breadcrumbs
            items={[{ label: 'C a r e e r G u i d a n c e' }]}
        ...
        <Container>
          <div className="rounded-2xl border border-border-default bg-white p-8 lg:p-12 shadow-sm">
            ...
            <div className="prose prose-lg text-text-secondary max-w-none">
              <p>
                We are in the process of adding detailed content for <strong>C a r e e r G u i d a n c e</strong>. 
