...
export default function StudyMaterialPage() {
  return (
    <>
      <SEOHead
        title="S t u d y M a t e r i a l â€” Malhotra Classes"
        description="Learn more about S t u d y M a t e r i a l at Malhotra Classes, Rohtak's premier coaching institute."
      />
      ...
      <div className="bg-brand-navy pt-8 pb-16 lg:pt-12 lg:pb-24">
        <Container>
          <Breadcrumbs
            items={[{ label: 'S t u d y M a t e r i a l' }]}
        ...
        <Container>
          <div className="rounded-2xl border border-border-default bg-white p-8 lg:p-12 shadow-sm">
            ...
            <div className="prose prose-lg text-text-secondary max-w-none">
              <p>
                We are in the process of adding detailed content for <strong>S t u d y M a t e r i a l</strong>. 
