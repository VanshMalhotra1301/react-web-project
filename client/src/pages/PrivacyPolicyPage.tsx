...
export default function PrivacyPolicyPage() {
  return (
    <>
      <SEOHead
        title="P r i v a c y P o l i c y â€” Malhotra Classes"
        description="Learn more about P r i v a c y P o l i c y at Malhotra Classes, Rohtak's premier coaching institute."
      />
      ...
      <div className="bg-brand-navy pt-8 pb-16 lg:pt-12 lg:pb-24">
        <Container>
          <Breadcrumbs
            items={[{ label: 'P r i v a c y P o l i c y' }]}
        ...
        <Container>
          <div className="rounded-2xl border border-border-default bg-white p-8 lg:p-12 shadow-sm">
            ...
            <div className="prose prose-lg text-text-secondary max-w-none">
              <p>
                We are in the process of adding detailed content for <strong>P r i v a c y P o l i c y</strong>. 
