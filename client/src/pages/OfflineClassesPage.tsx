...
export default function OfflineClassesPage() {
  return (
    <>
      <SEOHead
        title="O f f l i n e C l a s s e s â€” Malhotra Classes"
        description="Learn more about O f f l i n e C l a s s e s at Malhotra Classes, Rohtak's premier coaching institute."
      />
      ...
      <div className="bg-brand-navy pt-8 pb-16 lg:pt-12 lg:pb-24">
        <Container>
          <Breadcrumbs
            items={[{ label: 'O f f l i n e C l a s s e s' }]}
        ...
        <Container>
          <div className="rounded-2xl border border-border-default bg-white p-8 lg:p-12 shadow-sm">
            ...
            <div className="prose prose-lg text-text-secondary max-w-none">
              <p>
                We are in the process of adding detailed content for <strong>O f f l i n e C l a s s e s</strong>. 
