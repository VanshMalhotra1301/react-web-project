$pages = @(
    "AchievementsPage", "FeeStructurePage", "ScholarshipsPage", "FAQsPage", 
    "FreeNotesPage", "StudyMaterialPage", "MockTestsPage", "CareerGuidancePage", 
    "OnlineClassesPage", "OfflineClassesPage", "PrivacyPolicyPage", 
    "TermsPage", "RefundPolicyPage", "SitemapPage", "BlogPage", "BlogDetailPage"
)
...
export default function ${page}() {
  return (
    <>
      <SEOHead
        title="${title} — Malhotra Classes"
        description="Learn more about ${title} at Malhotra Classes, Rohtak's premier coaching institute."
      />
        ...
        <Container>
          <div className="rounded-2xl border border-border-default bg-white p-8 lg:p-12 shadow-sm">
            ...
            <div className="prose prose-lg text-text-secondary max-w-none">
              <p>
                We are in the process of adding detailed content for <strong>${title}</strong>. 
...
"@
    Set-Content -Path "c:\Users\vansh\OneDrive - BENNETT UNIVERSITY\Desktop\malhotra classes\client\src\pages\${page}.tsx" -Value $content -Encoding UTF8
}
